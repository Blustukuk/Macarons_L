Public Class frmLapPenerimaanPeriode
    Private Sub frnLapPenerimaanPeriode_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Call frmLapPengirimanPeriodeLoad()
    End Sub
    ...
    Private Sub btnProses_Click(sender As Object, e As EventArgs) Handles btnProses.Click
        lappenerimaanperiodeclick(dtp1.Value, dtp2.Value, cbxTenant.SelectedValue)
        Dispose()
    End Sub
End Class