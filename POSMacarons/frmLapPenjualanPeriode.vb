Public Class frmLapPenjualanPeriode
    Private Sub frmLapPenjualanPeriode_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnProses_Click(sender As Object, e As EventArgs) Handles btnProses.Click
        lappenjualanperiodeclick(dtp1.Value, dtp2.Value)
        Dispose()
    End Sub
End Class