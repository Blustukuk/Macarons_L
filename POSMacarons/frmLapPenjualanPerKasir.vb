Public Class frmLapPenjualanPerKasir
    Private Sub btnClose_Click(sender As Object, e As EventArgs) Handles btnClose.Click
        Dispose()
    End Sub

    Private Sub frmLapPenjualanPerKasir_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnProses_Click(sender As Object, e As EventArgs) Handles btnProses.Click
        lappenjualanperkasirclick(dtp1.Value, dtp2.Value)
        Dispose()
    End Sub
End Class