...
Public Class PenjualanPerTenant
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSMacarons.PenjualanPerTenant.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPenjualanPerTenant
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PenjualanPerTenant = New PenjualanPerTenant()
        rpt.Site = Me.Site
        Return rpt
    End Function
