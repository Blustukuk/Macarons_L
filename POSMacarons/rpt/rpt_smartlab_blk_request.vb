...
Public Class rpt_smartlab_blk_request
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_smartlab_blk_request.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSMacarons.rpt_smartlab_blk_request.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_POrderID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_smartlab_blk_request
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_smartlab_blk_request = New rpt_smartlab_blk_request()
        rpt.Site = Me.Site
        Return rpt
    End Function
