...
Public Class PenjualanPerNota2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSMacarons.PenjualanPerNota2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPenjualanPerNota2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PenjualanPerNota2 = New PenjualanPerNota2()
        rpt.Site = Me.Site
        Return rpt
    End Function
