...
Public Class Nota_DiskonKembar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSMacarons.Nota-DiskonKembar.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_nota() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedNota_DiskonKembar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Nota_DiskonKembar = New Nota_DiskonKembar()
        rpt.Site = Me.Site
        Return rpt
    End Function
