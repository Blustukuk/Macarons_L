...
Public Class PenjualanPerKasir
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSMacarons.PenjualanPerKasir.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPenjualanPerKasir
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PenjualanPerKasir = New PenjualanPerKasir()
        rpt.Site = Me.Site
        Return rpt
    End Function
