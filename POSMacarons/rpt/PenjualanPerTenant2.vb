...
Public Class PenjualanPerTenant2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PenjualanPerTenant2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSMacarons.PenjualanPerTenant2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPenjualanPerTenant2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PenjualanPerTenant2 = New PenjualanPerTenant2()
        rpt.Site = Me.Site
        Return rpt
    End Function
