...
Public Class StokBeliKirimTenant
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "StokBeliKirimTenant.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSMacarons.StokBeliKirimTenant.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_cari() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedStokBeliKirimTenant
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StokBeliKirimTenant = New StokBeliKirimTenant()
        rpt.Site = Me.Site
        Return rpt
    End Function
