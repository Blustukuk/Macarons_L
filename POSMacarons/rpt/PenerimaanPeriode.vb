...
Public Class PenerimaanPeriode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSMacarons.PenerimaanPeriode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPenerimaanPeriode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PenerimaanPeriode = New PenerimaanPeriode()
        rpt.Site = Me.Site
        Return rpt
    End Function
