...
Public Class PenjualanEDCQRIS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSMacarons.PenjualanEDCQRIS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPenjualanEDCQRIS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PenjualanEDCQRIS = New PenjualanEDCQRIS()
        rpt.Site = Me.Site
        Return rpt
    End Function
