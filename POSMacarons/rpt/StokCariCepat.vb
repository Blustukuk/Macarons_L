...
Public Class StokCariCepat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSMacarons.StokCariCepat.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_namaCari() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedStokCariCepat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StokCariCepat = New StokCariCepat()
        rpt.Site = Me.Site
        Return rpt
    End Function
