...
Public Class PenjualanPeriode2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSMacarons.PenjualanPeriode2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPenjualanPeriode2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PenjualanPeriode2 = New PenjualanPeriode2()
        rpt.Site = Me.Site
        Return rpt
    End Function
