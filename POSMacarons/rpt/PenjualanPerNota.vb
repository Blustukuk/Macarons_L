...
Public Class PenjualanPerNota
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSMacarons.PenjualanPerNota.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPenjualanPerNota
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PenjualanPerNota = New PenjualanPerNota()
        rpt.Site = Me.Site
        Return rpt
    End Function
