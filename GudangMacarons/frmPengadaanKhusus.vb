Public Class frmPengadaanKhusus
    ...
    Private Sub frmPengadaan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Call gantiwarnaform(sender, 0, 184, 148)
        Call frmPengadaanKhususLoad()
    End Sub
    ...
    Private Sub btnProses_Click(sender As Object, e As EventArgs) Handles btnProses.Click
        If dgvtemp.Rows.Count > 0 Then
            Dim proses As Boolean = prosesPengadaanKhusus(txtJudul.Text, cbxLogo.SelectedValue, frmMain.lblUserID.Text)
            If proses Then
                lblproses.Text = "0"
                lbltotal.Text = "0"
                frmPengadaanLoad()
    ...
    Private Sub dgvtemp_CellEndEdit(sender As Object, e As DataGridViewCellEventArgs) Handles dgvtemp.CellEndEdit
        If dgvtemp.Rows.Count > 0 Then
            updatePengadaanTemp(getnumber(dgvtemp.CurrentRow.Cells(10).Value.ToString), getnumber(dgvtemp.CurrentRow.Cells(12).Value.ToString), getnumber(dgvtemp.CurrentRow.Cells(13).Value.ToString), dgvtemp.CurrentRow.Cells(0).Value.ToString)
            pengadaanAfterProses()
        End If
    End Sub
