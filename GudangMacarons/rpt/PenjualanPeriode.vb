...
Public Class PenjualanPeriode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GudangMacarons.PenjualanPeriode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPenjualanPeriode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PenjualanPeriode = New PenjualanPeriode()
        rpt.Site = Me.Site
        Return rpt
    End Function
