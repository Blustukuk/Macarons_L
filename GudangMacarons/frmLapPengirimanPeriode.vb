Public Class frmLapPengirimanPeriode
    Private Sub btnClose_Click(sender As Object, e As EventArgs) Handles btnClose.Click
        Dispose()
    End Sub
    Private Sub btnProses_Click(sender As Object, e As EventArgs) Handles btnProses.Click
        lappenjualanperiodeclick(dtp1.Value, dtp2.Value, cbxTenant.SelectedValue)
        Dispose()
    End Sub

    Private Sub frmLapPengirimanPeriode_Load(sender As Object, e As EventArgs) Handles MyBase.Load
